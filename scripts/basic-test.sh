...
test -f compose/haproxy/haproxy.cfg && ok "haproxy.cfg exists" || err "missing haproxy.cfg"
grep -q "dev.local" compose/haproxy/haproxy.cfg && ok "haproxy routes dev.local" || err "haproxy missing dev.local"
